...
class Encoder:
    ...
    def add_dit(self, rows, samples_per_dit):
...
class Morse:
    ...
    def _morse_df(self, morse_code, encoder, samples_per_dit):
        rows = []
