...
if __name__ == "__main__":
    ...
    s = "NGHIEM TUAN KHOI HUST += 080401"
    samples_base, spec_base, y_base = generate_sample(length, 100, 10, 0, 10, s)
    ...
    plt.plot(samples[0:len(samples)]*0.8, label="sig_noise", color="cornflowerblue")

    plt.figure(figsize=(50,5))
    plt.plot(samples_base[0:len(samples_base)]*0.8, label="sig", color="cornflowerblue")
    plt.show()